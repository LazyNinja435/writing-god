...
7. Optionally emit a `canon-change` narrative event if story history must reflect the change — never mutate old events; use correction/supersession when replacing prior narrative deltas
